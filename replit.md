...
- **Single source of truth**: `shared/featureFlags.ts::FEATURES` — 23 flag keys; `investorDemo`, `executiveReport`, `arkResume`, `cardVerification`, `trainingProviders`, and `f1000Promo` default `true`, all others default `false`.
