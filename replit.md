...
- **Single source of truth**: `shared/featureFlags.ts::FEATURES` — 24 flag keys; `investorDemo`, `executiveReport`, `arkResume`, `cardVerification`, `trainingProviders`, `f1000Promo`, and `matchmaking` default `true`, all others default `false`.
